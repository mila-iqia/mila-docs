...
`srun/salloc` ([srun ](https://slurm.schedmd.com/srun.html)/`salloc
...
`sinfo` ([ref. ](https://slurm.schedmd.com/sinfo.html)_) provides most of the
...
`scontrol` ([ref. ](https://slurm.schedmd.com/scontrol.html)_) can be used to

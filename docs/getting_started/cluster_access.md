---
title: Enable your cluster access
description: >-
  Obtain a Mila account and enable cluster access.
...
This guide covers obtaining your Mila account (`@mila.quebec`) and enabling your cluster
access.
...
-   [:material-run-fast:{ .lg .middle } __Set up Multi-Factor Authentication__](mfa.md)
    { .card }

    ---
    Configure your MFA second token.

...
* For every node, there is a web interface from Netdata itself at `<node>.server.mila.quebec:19999`.
  ...
  * SSH tunnelling: on your local machine, run
    ...
    * or `ssh -L 19999:<node>.server.mila.quebec:19999 mila` if you have
      already setup your [SSH Login](Userguide_login.md#ssh-secure-shell),
...
* The Mila dashboard at [dashboard.server.mila.quebec](https://dashboard.server.mila.quebec/)
  ...
  These are collected internally to an instance of [prometheus](https://prometheus.io/).
...
![monitoring_cpu](monitoring_cpu.png)
...
![monitoring_ram](monitoring_ram.png)
...
![monitoring_gpu](monitoring_gpu.png)

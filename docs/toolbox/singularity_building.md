...
them on [dockerhub](https://hub.docker.com/).

Go on [dockerhub](https://hub.docker.com/) and select the container you want to pull.
...
description, please look at the [singularity documentation](https://www.sylabs.io/guides/2.6/user-guide/container_recipes.html#container-recipes).
...
yourself.  You need to register on [singularity-hub](https://www.singularity-hub.org/) and link your
singularity-hub account to your GitHub account, then:

1. Create a new github repository.
2. Add a collection on [singularity-hub](https://www.singularity-hub.org/) and select the github repository your created.

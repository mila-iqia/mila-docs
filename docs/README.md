...
- [Getting started](getting_started/index.md)
    - [Enable your cluster access](getting_started/cluster_access.md)
    - [Set up Multi-Factor Authentication (MFA)](getting_started/mfa.md)
    - [Connect to the cluster](getting_started/connect_to_the_cluster.md)
    ...
    - Minimal Examples
        ...
        - [Distributed Training](examples/distributed/index.md)
            - [Single GPU Job](examples/distributed/single_gpu/index.md)
                - [Single GPU Job with Jax](examples/distributed/single_gpu/single_gpu_jax/index.md)

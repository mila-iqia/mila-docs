<!-- NOTE: This file is auto-generated from examples/good_practices/hpo_with_orion/index.md
...
* [Single GPU Job](https://github.com/mila-iqia/mila-docs/tree/master/docs/examples/distributed/single_gpu)
...
For more complex and useful plots, see [Oríon documentation](https://orion.readthedocs.io/en/stable/auto_examples/plot_4_partial_dependencies.html).

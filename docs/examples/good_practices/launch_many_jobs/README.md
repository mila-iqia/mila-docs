...
Compared to the [single_gpu_job](#single_gpu_job) example, here we use the `$@` bash directive
...
You can run this example just like the [single_gpu_job](#single_gpu_job) example, but you can now
...
* [Using SLURM Job Arrays to launch lots of jobs ](#slurm_job_arrays)
* [Running more effective Hyper-Parameter Sweeps with Orion ](#hpo_with_orion)
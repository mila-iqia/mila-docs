...
Click here to see `the code for this example <https://github.com/lebrice/mila-docs/tree/pytorch_distributed_training_examples/docs/examples/distributed/002_multi_gpu>`_

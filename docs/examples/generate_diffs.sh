...
# single_gpu -> howto_launch_many_jobs
generate_diff distributed/single_gpu/job.sh good_practices/howto_launch_many_jobs/job.sh
generate_diff distributed/single_gpu/main.py good_practices/howto_launch_many_jobs/main.py

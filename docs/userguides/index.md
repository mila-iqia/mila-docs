...
| [Launch jobs](../userguides/slurm_guide/) | Launch your jobs on the cluster |
...
| [Share data with ACLs](../userguides/sharing_data) | Use ACLs to allow a user to share with another one a "playground" folder hierarchy in Mila's scratch filesystem at a location in a safe and secure fashion that allows both users to read, write, execute, search and delete each others' files |

  ...
  <div class="wf2-board">
    ...
    <div class="wf2-lane wf2-lane-prepare">
      ...
      <div class="wf2-lane-steps">
        <a class="wf2-step wf2-s1" href="login">
          ...
          <div class="wf2-text">
            <span class="wf2-title">Connect to the cluster</span>
            <span class="wf2-desc">SSH &amp; auth</span>
          </div>

          <span class="wf2-chevron"></span>
        </a>
        <a class="wf2-step wf2-s1" href="python_uv/">
          ...
          <div class="wf2-text">
            <span class="wf2-title">Environment set up</span>
            <span class="wf2-desc">Portability</span>
          </div>
          <span class="wf2-chevron"></span>
        </a>

        <a class="wf2-step wf2-s1" href="sharing_data/">
    ...
    <div class="wf2-lane wf2-lane-execute">
      ...
      <div class="wf2-lane-steps">
        ...
        <a class="wf2-step wf2-s2" href="slurm_guide/">
    ...
    <div class="wf2-lane wf2-lane-iterate">
      ...
      <div class="wf2-lane-steps">
        ...
        <a class="wf2-step wf2-s3" href="reproducibility">

...
|-------|----------------|-------------|
| `mila-write-guide` | "write a guide for X", "create a how-to for X", "update the guide at docs/X.md" | Drafts or edits a how-to guide following the guide template and MkDocs Material conventions |
| `mila-standardize-tone` | "standardize the tone of docs/X.md", "fix the tone", "apply tone rules to X" | Audits a doc for tone violations and applies fixes |
